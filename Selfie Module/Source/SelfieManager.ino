//See SelfieProgrammingInstructions.txt for programming instructions.
//See Selfie Arduino IDE Settings.bmp for IDE set up.
//See IMG_4083.jpg for an image of the connections.
